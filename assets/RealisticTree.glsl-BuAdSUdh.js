import{iR as $e,lq as ta,ll as Q,d2 as oa,lk as Ee,ix as Pa,e9 as U,cA as $,ny as Ra,_ as me,hl as ra,lb as ne,a8 as s,a9 as be,aa as Fa,aT as oe,bP as Da,bT as je,bW as ja,bU as Va,bv as Ba,hT as Ha,kP as Wa,l2 as Ua,az as qa,dw as E,d3 as Ya,lz as ka,qP as Za,lh as Ve,lv as Be,dO as Xa,dB as Ja,dD as Ka,dP as Te,e4 as Qa,dS as He,dy as et,iv as at}from"./index-YH06oXPr.js";import{H as tt}from"./InterleavedLayout-5EojbwEz.js";import{n as g,u as ee,t as We,o as we,r as ot}from"./ShaderOutput-DnYY5J1_.js";import{n as _,a as T,t as he}from"./NormalAttribute.glsl-_Xrt7P2e.js";import{aZ as rt,a_ as it,a$ as G,b0 as nt,b1 as st,b2 as lt,B as se,p as ct,I as dt,q as ut,e as I,an as R,a as j,a2 as V,b3 as B,a4 as K,E as N,a6 as H,au as mt,a5 as ht,b4 as ft,ak as F,b5 as pt,H as ia,as as na,D as sa,aX as la,P as vt,L as ze,M as fe,G as ca,b6 as gt,g as le,aP as xt,Q as bt,S as Me,R as re,k as da,o as O,b7 as h,aO as _e,y as Oe,z as ce,j as Tt,b8 as wt,b9 as Mt,x as ua,J as St,aa as yt,ba as ma,bb as ha,c as de,bc as fa,a3 as pa,a9 as va,a8 as ga,a7 as xa,F as ue,bd as ba,U as Ct,T as Ue,af as Nt,ag as Ot,ah as $t,ai as Et,ab as zt,ac as _t,ad as At,ae as It,aj as Gt,al as P,Y as d,a0 as Lt,A as Se,am as Pt,az as Rt,a1 as Ft,d as Dt,ao as jt,v as Vt,aJ as Bt}from"./Geometry-CkL16Nl_.js";import{i as A,a as qe,e as ae,n as pe}from"./basicInterfaces-CZwQPxTp.js";import{e as b}from"./VertexAttribute-Cq4MnHjR.js";import{B as Ae,g as Ie,f as Ht}from"./renderState-B_fO20Wx.js";import{n as r,t as v}from"./glsl-BH37Aalp.js";import{a as Ge}from"./BindType-BBwFZqyN.js";import{i as ve}from"./ShaderBuilder-BOVv14CF.js";import{e as Le,o as q}from"./mat3f64-q3fE-ZOt.js";import{o as Ye}from"./mat4f64-Dk4dwAN8.js";import"./boundedPlane-QiBOQdIr.js";import"./sphere-ClBMg3Wm.js";import{o as Wt,r as Ut}from"./doublePrecisionUtils-B0owpBza.js";function qt(a){a.vertex.code.add(r`
...
}`);break;case T.ScreenDerivative:a.vertex.code.add(r`void forwardNormal() {}`);break;default:$e(e.normalType);case T.COUNT:}}let Yt=class extends rt{constructor(){super(...arguments),this.transformNormalViewFromGlobal=Le()}},kt=class extends nt{constructor(){super(...arguments),this.transformNormalGlobalFromModel=Le(),this.toMapSpace=ta()}};function ar({normalTexture:a,metallicRoughnessTexture:e,metallicFactor:t,roughnessFactor:o,emissiveTexture:i,emissiveFactor:n,occlusionTexture:c}){return a==null&&e==null&&i==null&&(n==null||oa(n,Ee))&&c==null&&(o==null||o===1)&&(t==null||t===1)}const Zt=Q(1,1,.5),tr=Q(0,.6,.2),or=Q(0,1,.2);function wa(a){a.vertex.code.add(r`vec4 offsetBackfacingClipPosition(vec4 posClip, vec3 posWorld, vec3 normalWorld, vec3 camPosWorld) {
...
}`))}const ea=$(),z=ta();function uo(a){const e=a.fragment.code;e.add(r`vec3 evaluateDiffuseIlluminationHemisphere(vec3 ambientGround, vec3 ambientSky, float NdotNG)
{
...
}`)}function Re(a,e){const t=a.fragment.code;a.include(_e),e.pbrMode!==h.Normal&&e.pbrMode!==h.Schematic&&e.pbrMode!==h.Simplified&&e.pbrMode!==h.TerrainWithWater||(t.add(r`float normalDistribution(float NdotH, float roughness)
{
...
return outColor;
}`))}function cr(a,e){const t=a.fragment.code;a.include(_e),t.add(r`
...
}`)}function Fe(a){a.constants.add("ambientBoostFactor","float",Mt)}function De(a){a.uniforms.add(new le("lightingGlobalFactor",e=>e.lighting.globalFactor))}function $a(a,e){const t=a.fragment;switch(a.include(Pe,e),e.pbrMode!==h.Disabled&&a.include(Re,e),a.include(co,e),a.include(_e),t.code.add(r`
