...
}`),a.uniforms.add(new hi("stipplePatternTexture",s=>s.stippleTexture),new Z("stipplePatternSDFNormalizer",s=>_r(s.stipplePattern)),new Z("stipplePatternPixelSizeInv",s=>1/$t(s))),e.stippleOffColorEnabled&&a.uniforms.add(new Be("stippleOffColor",s=>vr(s.stippleOffColor))),a.code.add(p`float getStippleSDF(out bool isClamped) {
